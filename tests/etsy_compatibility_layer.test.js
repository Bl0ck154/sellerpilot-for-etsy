...
assert.match(source, /const domFallback = extractDomConversation/);
assert.match(source, /const fallback = embedded \|\| domFallback/);
assert.match(source, /ScopedConversationStore/);
assert.match(source, /scopedStore\?\.setHistory/);
